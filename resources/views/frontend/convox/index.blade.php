            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="card-body">
                        ...
                        @if($setting != null)
                            <a href="{{ route('convox.edit') }}" title="Edit CRM" class="btn btn-primary btn-sm"><i aria-hidden="true" class="fa fa-pencil-square-o"></i> Edit
                            </a>
                        @else
                            <a href="{{ route('convox.edit') }}" title="Create CRM" class="btn btn-primary btn-sm"><i aria-hidden="true" class="fa fa-plus"></i> Create
                            </a>
                        @endif
                        </div>
